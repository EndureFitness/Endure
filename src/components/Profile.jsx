...
const st = {
  ...
  idName: { fontFamily:'var(--font-head)', fontSize:22, color:'var(--text)', fontWeight:800, letterSpacing:'0.06em', marginTop:2, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' },
  idMeta: { fontSize:10, color:'var(--text-muted)', marginTop:4, letterSpacing:'0.06em', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' },
  ...
  goalChip: { flex:1, height:44, background:'var(--surface-1)', border:'1px solid var(--border)', color:'var(--text-muted)', fontFamily:'var(--font-head)', fontSize:12, letterSpacing:'0.12em', cursor:'pointer', borderRadius:3, fontWeight:700 },
